	...
	public class CodeMenu : TextEditorMenu
	{
		...
		public AsmWord CurrentWord
		{
			set
			{
				...
				{
					GoToDefinitionOption.Enabled = (value.WordType == AsmWord.AsmWordType.LabelAbsolute || value.WordType == AsmWord.AsmWordType.LabelReference || value.WordType == AsmWord.AsmWordType.Macro);
